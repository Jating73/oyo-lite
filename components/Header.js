...
export default function Header({ showSearchBar = false }) {
    return (
        <div className={showSearchBar ? classes.headerSticky : classes.headerWrapper}>
            <div className={classes.headerWrapper__primary}>
                <div className={showSearchBar ? classes.headerWrapper__leftSearch : classes.headerWrapper__left}>
                ...
                <div className={showSearchBar ? classes.headerWrapper__rightSearch : classes.headerWrapper__right}>
                    {showSearchBar ? (
                        <>
                            <SearchWidget showSearchBar={showSearchBar} />
                        </>
                    ) :
                        <>
